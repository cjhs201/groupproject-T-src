...
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, UserProfileView, Leaderboard, PostCompletedView
from . import views
...
urlpatterns = [
    ...
    path('leaderboard/', Leaderboard.as_view(), name="gamma-leaderboard"),
